// app/[lang]/dashboard/calendar/jobs/jobs-client.tsx
"use client";
        ...
        <div>
          ...
          <Select value={filterJobStatus} onValueChange={setFilterJobStatus}>
            ...
            <SelectContent>
              ...
              <SelectItem value="active">{t("filters.activeJobs")}</SelectItem>
            ...
            <>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {paginatedJobs.map((job) => {
                  ...
                  const totalPositionsNeeded = job.total_positions_needed || 0;
                  ...
                  const isOverstaffed = totalAssignments > totalPositionsNeeded;
